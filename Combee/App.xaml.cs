...
namespace Combee
{
    public partial class App : Application
    {
        ...
        // 静态观测模型, 在整个程序中都可被使用.
        private static TheViewModel newViewModel;
        public static TheViewModel NewViewModel
        {
            get { return newViewModel; }
        }
        ...
        public App()
        {
            ...
            // 指定本地数据库的连接字符串.
            string DBConnectionString = "Data Source=isostore:/my.sdf";
            ...
            // 创建观测模型对象.
            newViewModel = new TheViewModel(DBConnectionString);

            // 查询本地数据库并加载可观测模型.
            newViewModel.LoadCollectionsFromDatabase();
        }
